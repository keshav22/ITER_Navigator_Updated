       ...
       /* mDrawer = (DrawerLayout) findViewById(R.id.myacctdraw);
        ...
        toggleButton.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                ...
                bsk.execute(email.getText().toString());
            }
        });
       // Backtask bsk=new Backtask();
       // bsk.execute(name12);
    ...
    public class Backtask extends AsyncTask<String,Void,String>
    {
        ...
        protected void onPostExecute(String s)
        {
            ...
            for(int i=0;i<n;i++)
            {
                ...
                {
                    sh=getSharedPreferences("Signin",getApplicationContext().MODE_PRIVATE);
                    String n00=sh.getString("number","");
                    if(separated[3].toLowerCase().compareTo("head of department")==0 && n00.compareTo("13")==0)
                    {
                        Intent in = new Intent(myaccount.this, Myservice.class);
                        startService(in);
                    }
                    sh=getSharedPreferences("Signin",getApplicationContext().MODE_PRIVATE);
                    SharedPreferences.Editor editor1=sh.edit();
            ...
            bvn.execute(email.getText().toString());
